...
if hyper['alg'] in ['TRPO', 'PPO']:
    log_folder = hyper['alg']+str(hyper['clip'])+'_'+hyper['pl']+str(hyper['pls'][0])+'_'\
    ...
    log_folder = hyper['alg']+'_'+hyper['buffer']+'_'+hyper['expl']+'_'+hyper['pl']+str(hyper['pls'][0])+'_'+str(hyper['pls'][1]) +'_qf'\
