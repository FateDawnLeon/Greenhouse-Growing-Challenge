...
SPACES = {
    ...
    'E1': { # COPY D1 -> best netprofit: 5.499 '1 90; 8 65; 18 45; 26 25; 35 15'
        "num_days": 40,
        "heatingTemp_night": 3,
        "heatingTemp_day": 20,
        "CO2_pureCap": 270,
    ...
    'E2': { # BASED ON E1 -> best netprofit: 9.398
        "num_days": tune.qrandint(lower=35, upper=40, q=1),
        "heatingTemp_night": tune.quniform(lower=2, upper=10, q=0.5),
        "heatingTemp_day": tune.quniform(lower=15, upper=25, q=0.5),
        "CO2_pureCap": tune.qrandint(lower=260, upper=280, q=5),
    ...
    'E2BEST': { # BASED ON E1 -> best netprofit: 9.398
        'num_days': 36, 
        'heatingTemp_night': 8.0, 
        'heatingTemp_day': 20.5, 
        'CO2_pureCap': 280, 
        'CO2_setpoint_night': 430, 
        'CO2_setpoint_day': 1150, 
        'CO2_setpoint_lamp': 1180, 
        'light_intensity': 3, 
        'light_hours': 9, 
    ...
    'F1BST': { # netprofit=4.485 and parameters={'start_date_gap': 7, 'duration': 36, 'heatingTemp_night': 8.0, 'heatingTemp_day': 20.5, 'CO2_pureCap': 280, 'CO2_setpoint_night': 430, 'CO2_setpoint_day': 1150, 'CO2_setpoint_lamp': 0, 'light_intensity': 3, 'light_hours': 9, 'light_endTime': 17, 'light_maxIglob': 300, 'scr1_ToutMax': 4.4, 'vent_startWnd': 55, 'plantDensity': '1 90; 6 60; 15 40; 25 25; 33 15'}
        "start_date_gap": 7,
        "duration": 36,
        "heatingTemp_night": 8.0,
        "heatingTemp_day": 20.5,
        ...
        "scr1_ToutMax": 4.4,
        "vent_startWnd": 55,
        "plantDensity": '1 90; 6 60; 15 40; 25 25; 33 15',
    },
    'F2': {  #  max 5.008
        "start_date_gap": tune.qrandint(lower=0, upper=30, q=2), # 4 
        "duration": tune.qrandint(lower=35, upper=45, q=1),  # 35
        "heatingTemp_night": tune.quniform(lower=2, upper=10, q=0.5),  # 7.5
        "heatingTemp_day": tune.quniform(lower=15, upper=25, q=0.5),  # 21
        "CO2_pureCap": tune.qrandint(lower=260, upper=280, q=5),  # 280
        "CO2_setpoint_night": tune.qrandint(lower=400, upper=600, q=10),  # 480
        "CO2_setpoint_day": tune.qrandint(lower=1100, upper=1200, q=10),  # 1110
        "CO2_setpoint_lamp": 0,
        "light_intensity": tune.qrandint(lower=0, upper=100, q=10),  # 20
        "light_hours": tune.qrandint(lower=0, upper=18, q=1),  # 8
        "light_endTime": tune.quniform(lower=18, upper=20, q=0.5),  # 19.5
        "light_maxIglob": tune.qrandint(lower=200, upper=500, q=10),  # 260
        "scr1_ToutMax": tune.quniform(lower=4, upper=6, q=0.2),  # 5
        "vent_startWnd": tune.quniform(lower=50, upper=55, q=0.5), # 55
        "plantDensity": '1 90; 6 60; 15 40; 25 25; 33 15',
    }
}
